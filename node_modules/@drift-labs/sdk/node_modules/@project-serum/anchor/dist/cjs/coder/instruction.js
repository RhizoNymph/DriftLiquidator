...
class InstructionCoder {
    constructor(idl) {
        ...
        idl.instructions.forEach((ix) => {
            const sh = (0, common_js_1.sighash)(exports.SIGHASH_GLOBAL_NAMESPACE, ix.name);
        ...
        if (idl.state) {
            idl.state.methods.map((ix) => {
                const sh = (0, common_js_1.sighash)(exports.SIGHASH_STATE_NAMESPACE, ix.name);
                sighashLayouts.set(bs58_1.default.encode(sh), {
                    layout: this.ixLayout.get(ix.name),
                    name: ix.name,
                });
    ...
    _encode(nameSpace, ixName, ix) {
        ...
        return buffer_1.Buffer.concat([(0, common_js_1.sighash)(nameSpace, ixName), data]);
    }
